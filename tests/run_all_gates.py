...
def main():
    ...
    results.append(
        run_gate(
            ...
            [sys.executable, "-m", "tests.chip_compatibility.compare_chip_source_compatibility_v1"],
        )
    )
    ...
    results.append(
        run_gate(
            ...
            [sys.executable, "-m", "tests.unit_evidence.compare_chip_unit_evidence_v1"],
        )
    )
    ...
    results.append(
        run_gate(
            ...
            [
                sys.executable,
                "-m",
                "tests.live_source.compare_live_fetch_safety_v1",
            ],
        )
    )
    ...
    results.append(
        run_gate(
            ...
            [
                sys.executable,
                "-m",
                "tests.live_source.compare_provider_request_safety_integration_v1",
            ],
        )
    )
    ...
    results.append(
        run_gate(
            ...
            [
                sys.executable,
                "-m",
                "tests.live_source.compare_read_only_transport_contract_v1",
            ],
        )
    )
    ...
    results.append(
        run_gate(
            ...
            [
                sys.executable,
                "-m",
                "tests.live_source.compare_finmind_golden_evidence_v1",
            ],
        )
    )
    ...
    results.append(
        run_gate(
            ...
            [
                sys.executable,
                "-m",
                "tests.live_source.compare_one_shot_live_fetch_integration_v1",
            ],
        )
    )
    ...
    results.append(
        run_gate(
            ...
            [
                sys.executable,
                "-m",
                "tests.live_source.compare_finmind_query_token_transport_v1",
            ],
        )
    )
    ...
    results.append(
        run_gate(
            ...
            [
                sys.executable,
                "-m",
                "tests.live_source.compare_finmind_market_semantic_evidence_v1",
            ],
        )
    )
